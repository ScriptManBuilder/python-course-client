          ...
          <CheckoutForm onSubmit={handleSubmit}>
            ...
            <BillingDescriptorSection>
              ...
              <BillingDescriptorText>
                Your credit card will be billed with the following descriptor: <strong>WILLCOL.COM</strong>. This is how the charge will appear on the cardholder's billing statement.
              </BillingDescriptorText>
            </BillingDescriptorSection>
            ...
            <div style={{ fontSize: '0.8rem', color: 'var(--minimal-gray-400)', marginTop: '20px', lineHeight: '1.6' }}>
              ...
              <p style={{ 
                ...
                <div>
                  ...
                  Your credit card will be billed with the following descriptor: <strong>WILLCOL.COM</strong>. This is how the charge will appear on your billing statement.
                </div>
              </p>
            </div>
          </OrderSummary>
